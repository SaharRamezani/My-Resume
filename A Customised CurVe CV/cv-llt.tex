...
\leftheader{
  {\LARGE\bfseries\sffamily Sahar Ramezani Jolfaei}

  \makefield{\faEnvelope[regular]}{\href{mailto:example@gmail.com}\texttt{6709190@studenti.unige.it}}
  ...
  % \makefield{{\scriptsize\simpleicon{x}}}{\!\href{https://x.com/overleaf_example}
  % {\texttt{@overleaf\_example}}}
  
  \makefield{\faLinkedin}
  {\href{https://www.linkedin.com/in/sahar-ramezani-jolfaei/}{\texttt{LinkedIn}}}

  \makefield{\faGithub}
  {\href{https://github.com/SaharRamezani}{\texttt{GitHub}}}

  %% Next line
  \makefield{\faGlobe}
  {\href{https://saharramezani.github.io/My-Resume/}{\texttt{Resume}}}
